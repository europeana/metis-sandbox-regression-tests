...
public class Chrome_Test {
    ...
    public void ChromeTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Small_dataset_chrome");
        ...
        select.selectByVisibleText("North Macedonia");
        ...
        select1.selectByVisibleText("Romanian");
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\IdeaProjects\\Sandbox\\Records\\small-valid-dataset.zip");
