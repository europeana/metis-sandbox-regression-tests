...
public class Edge_Test {
    ...
    public void EdgeTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Small_Dataset_edge");
        ...
        select1.selectByVisibleText("Greek");
