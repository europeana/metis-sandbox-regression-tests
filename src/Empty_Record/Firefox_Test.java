...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Empty_record_firefox");
        ...
        select1.selectByVisibleText("Interlingue");
