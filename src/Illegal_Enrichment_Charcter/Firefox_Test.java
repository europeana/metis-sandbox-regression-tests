...
public class Firefox_Test {
    ...
    //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Illegal_enrichment_character_firefox");
    ...
    Select select1 = new Select(language_drop_down);
        select1.selectByVisibleText("Finnish");
