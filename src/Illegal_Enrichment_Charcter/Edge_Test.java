package Illegal_Enrichment_Charcter;
...
public class Edge_Test {
    ...
    public void EdgeTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Illegal_enrichment_character_edge");
        ...
        select1.selectByVisibleText("Swedish");
        select1.selectByIndex(46);
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\IdeaProjects\\Sandbox\\Records\\llegal_enrichment_character.zip");
