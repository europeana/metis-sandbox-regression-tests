...
// maximize the browser
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_Step_size_firefox");
        ...
        select1.selectByVisibleText("Norwegian");
        select1.selectByIndex(37);
