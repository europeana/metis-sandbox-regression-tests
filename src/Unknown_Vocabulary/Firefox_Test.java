...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Deepti_Unknown_vocabulary_1");
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\Documents\\Records\\Sandbox_Test\\all_types_unknown_vocabulary.zip");
