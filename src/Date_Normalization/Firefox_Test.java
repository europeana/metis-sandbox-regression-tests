...
public class Firefox_Test {
    ...
    public void FirefoxTest() throws InterruptedException {
        ...
        //Enter a valid name
        driver.findElement(By.xpath("/html/body/sb-root/div[3]/sb-sandbox-navigation/main/div[2]/sb-upload/form/div[1]/input")).sendKeys("Automation_date_normalization_firefox");
        ...
        select1.selectByVisibleText("Czech");
        ...
        chooseFile.sendKeys("C:\\Users\\Deepti Pandit\\IdeaProjects\\Sandbox\\Records\\Date_Normalization_record.zip");
